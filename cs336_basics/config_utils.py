...
from cs336_basics.config_schema import Config, ModelConfig, OptimConfig, TrainerConfig, DataConfig
...
def load_config_from_yaml(config_path: str) -> Config:
    ...
    return Config(model=model, optim=optim, trainer=trainer, data=data, **config_dict)
