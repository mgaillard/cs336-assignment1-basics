...
def run_embedding(
    ...
    """
    # This is how you can use torch.nn.Embedding instead
...
def run_rmsnorm(
    ...
    """
    # This is how you can use torch.nn.RMSNorm instead
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    # This is how you can use torch.nn.Softmax instead
...
def run_cross_entropy(
    ...
    """
    # Using torch.nn.CrossEntropyLoss instead of implementing manually
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return torch.nn.utils.clip_grad_norm_(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    # Using PyTorch's AdamW implementation instead of implementing manually
